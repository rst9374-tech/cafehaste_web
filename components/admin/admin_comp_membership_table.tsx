                      ...
                      <div className="flex flex-col gap-1 text-left">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          {(() => {
                            ...
                            return <span className="text-red-580 font-extrabold text-[10px] bg-red-50 border border-red-150 rounded px-1">미첨부</span>;
                          })()}
                        </div>
                        
                        {/* 약정서 확인 */}
                        <div className="flex items-center gap-1.5 mt-1">
                          <span className="text-[9.5px] bg-stone-100 border border-stone-200 text-stone-405 px-1 rounded">약정서상태:</span>
                          {m.agreementDocumentUrl ? (
                            <a 
                              href={m.agreementDocumentUrl}
                              target="_blank"
                              rel="noreferrer"
                              className="px-2 py-0.5 bg-[#C5A059] hover:bg-[#b08e4d] text-white text-[10px] font-extrabold rounded shadow-xs transition-colors cursor-pointer flex items-center gap-0.5 leading-tight"
                            >
                              <FileText size={9} />
                              <span>확인</span>
                            </a>
                          ) : (
                            <span className="text-stone-400 font-extrabold text-[10px] bg-stone-50 border border-stone-150 rounded px-1">미체결</span>
                          )}
                        </div>
                      </div>
                    </div>
