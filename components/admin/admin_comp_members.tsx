...
import { 
  ShieldCheck, ShieldAlert, Terminal, HelpCircle, RefreshCw, BookOpen
} from 'lucide-react';
...
export const AdminMembersTab: React.FC<AdminMembersTabProps> = ({
  ...
  const [activeCategory, setActiveCategory] = useState<'FRANCHISE_INQUIRY' | 'MEMBERSHIP_LICENSES' | 'VALIDATOR' | 'GUIDEBOOK'>('FRANCHISE_INQUIRY');
