      ...
      <div className="bg-white border border-stone-200 w-full max-w-3xl rounded-[32px] overflow-hidden shadow-2xl flex flex-col my-6 max-h-[95vh] animate-fadeIn">
        ...
        <div className="bg-[#FAF9F6] border-b border-stone-150 py-4.5 px-6 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-2 text-stone-900">
            ...
            <h3 className="font-bold text-base tracking-tight font-serif">토스플레이스 키오스크 연동 규격서 (v2.4.0)</h3>
          </div>
...
{`{
  ...
  "message": "Order processed successfully"
            ...
            {/* 5. Dashboard Simulator Setting */}
            <div>
              <h5 className="font-bold text-stone-900 mb-2 flex items-center gap-1.5"><Layers size={14} className="text-[#C5A059]" /> 5. 모의 결제기 물리 매핑 필터링 규칙</h5>
              <div className="bg-stone-50 border border-stone-200 p-3.5 rounded-xl text-stone-600 space-y-2 leading-relaxed text-xs">
                <p>본사 어드민 관리자는 모의 결제기를 통해 가맹점 물리 세팅 상황을 시뮬레이션할 수 있습니다.</p>
                <ul className="list-disc pl-4 space-y-1.5">
                  <li><strong>컵 사이즈 단일 필터</strong>: 설정된 컵 사이즈(M/G/V/D)에 매칭되는 상품만 상품 선택 드롭다운에 노출됩니다.</li>
                  <li><strong>원두 구성 필터 (최대 2구)</strong>: 기기에 탑재된 원두 1(S/P/D) 및 원두 2(S/P/D) 설정 조건에 포함되는 원두 추출 음료들만 드롭다운에 노출됩니다.</li>
                  <li><strong>실시간 자동 필터링</strong>: 컵 사이즈와 원두 설정을 변경하면 아래 상품 선택 창의 품목들이 즉각 필터링됩니다.</li>
                </ul>
              </div>
            </div>
            ...
            {/* 6. Code Example */}
            <div>
              <h5 className="font-bold text-stone-900 mb-2 flex items-center gap-1.5"><Code size={14} className="text-[#C5A059]" /> 6. 로컬 수신 서버 Express(Node.js) 구현 예시</h5>
