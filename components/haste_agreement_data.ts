...
export const AGREEMENT_LINES = [
  ...
  "대상 상표 및 표시 범위: 헤이스트(HASTE) 명칭 및 로고 마크 일체로 하며, \"을\"은 본 계약 목적 범위 내에서 키오스크 화면 UI, 외부 간판, 소모품 등에 한하여 기술적 호환 및 솔루션 이용 점포임을 나타내는 목적으로 상표권자의 간섭 없이 단순 표시할 수 있다. \"갑\"은 이에 대해 별도의 상표 라이선스료(로열티)를 징수하지 아니한다.",
  ...
  "\"을\"이 월 이용료 정기구독 플랜을 유지하는 경우 가용 기간 연장 혜택을 제공한다. 6개월 정기구독 유지 시 +7일, 12개월 장기 정기구독 신청 시 +15일의 주말/휴일 가산 가동 일수 버퍼를 무상 지원한다.",
