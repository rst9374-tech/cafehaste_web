...
export const MembershipCompToss: React.FC = () => {
  ...
  return (
    <div className="w-full bg-[#070609]/95 border border-stone-900 rounded-2xl p-4 md:p-5 text-stone-300 font-sans shadow-lg relative overflow-hidden text-left">
      ...
      <div className="flex justify-between items-center border-b border-stone-900 pb-1.5 relative z-10">
        <span className="dashboard-card-subtitle flex items-center gap-1.5">
          <Layers className="w-3.5 h-3.5 text-[#C5A059]" />
          TOSS PLACE KIOSK SETUP <span className="text-stone-500 font-mono text-[9px] lowercase font-normal ml-1">v2.4.0</span>
        </span>
        <div className="dashboard-badge-text text-[#C5A059] font-sans bg-[#C5A059]/10 px-1.5 py-0.2 rounded-xl border border-[#C5A059]/20">DOWNDRAFT READY</div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 my-3.5 items-start relative z-10">
        ...
        <div className="md:col-span-6 flex flex-col gap-3 bg-stone-955/40 p-4 rounded-xl border border-stone-900/60">
          <span className="dashboard-panel-title flex items-center gap-1">
            ⚙️ 토스 키오스크 옵션 세팅
          </span>
          ...
          <div className="space-y-3 mt-1.5">
            {/* Cup Size */}
            <div>
              <label className="dashboard-form-label mb-1">1. 컵 사이즈 선택</label>
              <select
                value={selectedCup}
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setIncludeDessert(e.target.value)}
                className="dashboard-form-control w-full px-3 py-2 border border-stone-800 rounded-lg bg-stone-900 text-stone-200 focus:outline-none cursor-pointer focus:border-[#C5A059] transition-all"
              >
