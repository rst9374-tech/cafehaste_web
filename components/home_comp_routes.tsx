...
const HasteMenuAll = React.lazy(() => import('./menu_page_main_all').then(m => ({ default: m.HasteMenuAll })));
...
const HasteMenuAllMobile = React.lazy(() => import('./mobile/menu_page_mobile_all').then(m => ({ default: m.HasteMenuAllMobile })));
    ...
    <>
      {ctrl.currentRoute !== 'TEST_VALIDATOR' && (
        <HasteNavbar
          ...
          onOpenMyInfo={() => ctrl.navigateTo('CONTROL')}
          onLogout={() => {
        ...
        <div className="w-full">
          ...
          {ctrl.currentRoute === 'TEST_VALIDATOR' && (
            <div id="test-validator-view-wrapper">
              <Suspense fallback={<FallbackLoader />}>
                <AdminPageTestValidator mode="COFFEE" />
              </Suspense>
            </div>
          )}
