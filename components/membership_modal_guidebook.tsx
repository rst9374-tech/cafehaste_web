  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs font-sans overflow-y-auto">
      <div className="bg-[#F4EADB] w-full max-w-2xl rounded-[30px] overflow-hidden shadow-2xl flex flex-col my-8 max-h-[90vh]">
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6 text-xs text-stone-650 max-h-[750px]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-[#FAF9F6]/60 border border-stone-150 rounded-2xl p-4 flex gap-3.5 relative overflow-hidden">
              ...
              <div className="flex-1">
                ...
                <strong className="text-stone-850 font-bold text-[11.5px] block mb-1">멤버십 회원 가입 신청</strong>
                <p className="text-stone-550 leading-relaxed">점주 성함, 고유 매장 코드, 연락처, 사업자번호 등을 빠짐없이 입력하여 가입을 신청합니다. 신청 직후에는 헤이스트 심사 대기 상태인 <span className="font-bold text-amber-600">"인증 대기"</span> 상태가 유지됩니다.</p>
                <div className="mt-2.5 p-3 bg-stone-900/5 rounded-xl border border-[#C5A059]/10 text-[10px] leading-relaxed">
                  <div className="flex items-center gap-1.5 mb-2">
                    ...
                    <span className="text-stone-550 font-light">브랜드 상표 사용 여부에 따라 권리와 혜택 범위가 구분됩니다.</span>
                  </div>
                  <div className="flex flex-col gap-2 pl-3">
                    <div className="flex items-start gap-1.5 text-left">
                      ...
                      <span className="text-stone-750 font-medium flex-1">헤이스트 브랜딩 및 상표 라이선스(소모품 등)를 무상으로 사용하며, 간판(상표)을 설치하여 운영하는 형태입니다.</span>
                    </div>
                    <div className="flex items-start gap-1.5 text-left">
                      <span className="text-[#C5A059] shrink-0 mt-0.5">•</span>
                      <span className="haste-badge-membership text-[9px] px-1.5 py-0.5 rounded shrink-0">멤버십</span>
                      <span className="text-stone-550 font-light flex-1">헤이스트 브랜드를 사용하지 않고, 매장 고유의 자체 브랜드로 독자 운영하는 형태입니다.</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#FAF9F6]/60 border border-stone-150 rounded-2xl p-4 flex gap-3.5 relative overflow-hidden">
              ...
              <div className="flex-1">
                ...
                <strong className="text-stone-850 font-bold text-[11.5px] block mb-1">약정 확인 및 서명 날인 (도장)</strong>
                <p className="text-stone-550 leading-relaxed">결제 기간(1, 6, 12개월) 선택 시 화면에 약정 모달이 팝업됩니다. 점주는 본문 약관을 끝까지 스크롤하여 필독한 후, 헤이스트 직인이 사전 날인된 영역 옆에 **본인의 서명(도장)**을 드로잉합니다.</p>
            ...
            <div className="bg-[#FAF9F6]/60 border border-stone-150 rounded-2xl p-4 flex gap-3.5 relative overflow-hidden">
              ...
              <div className="flex-1">
                ...
                <strong className="text-stone-850 font-bold text-[11.5px] block mb-1">신용카드 정기/장기 구독 결제</strong>
                <p className="text-stone-550 leading-relaxed">서명이 정상 처리되면 포트원 카드 결제창이 팝업됩니다. 결제를 완수하면 백엔드 단에서 실제 지불 내역과 결제 금액 무결성을 2차 대조하는 안전 검증 과정을 수행합니다.</p>
              </div>
            </div>
            ...
            <div className="bg-[#FAF9F6]/60 border border-stone-150 rounded-2xl p-4 flex gap-3.5 relative overflow-hidden">
              ...
              <div className="flex-1">
                ...
                <strong className="text-stone-850 font-bold text-[11.5px] block mb-1">인증 완료 및 로컬 서버 연동 개방</strong>
                <p className="text-stone-550 leading-relaxed">검증 완료 즉시 매장 상태가 <span className="font-bold text-[#C5A059]">"인증 완료"</span>로 전환되며 고유 솔루션 라이선스 키가 연장 발급됩니다. 이에 따라 매장 내 **커피머신 로컬서버 가동 시** 필요한 모든 스마트 연동 시스템 권한이 즉시 개방됩니다.</p>
              </div>
            </div>

          </div>

          {/* Long Term Benefit Guide Info */}
          <div className="border border-stone-200 rounded-2xl p-4 flex flex-col gap-2.5 bg-stone-50">
            <span className="text-[#C5A059] font-black tracking-wide block uppercase text-[10.5px]">💡 장기 결제 및 가산 버퍼 연장 정책</span>
            <ul className="list-disc list-inside text-stone-550 space-y-1.5 pl-1">
              <li>**1개월 결제**: 55,000원 (정가, VAT 포함) / 가산 버퍼 연장 없음</li>
              <li>**6개월 결제**: 313,500원 (5% 즉시 할인, VAT 포함) / +7일 주말·휴일 버퍼 추가 연장</li>
              <li>**12개월 결제**: 594,000원 (10% 최대 할인, VAT 포함) / **+15일** 주말·휴일 버퍼 추가 연장</li>
              <li className="text-stone-600 font-bold">※ 결제 완료 시 합성 보관된 약정서 사본은 마이페이지 등록 대장 하단에서 언제든지 다시 내려받으실 수 있습니다.</li>
            </ul>
          </div>
