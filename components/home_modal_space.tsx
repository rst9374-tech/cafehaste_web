...
interface HasteHomeSpaceModalProps {
  selectedPopImage: {
    src: string;
    alt: string;
    styleTitle: string;
  ...
  setSelectedPopImage: (img: any | null) => void;
}

export const HasteHomeSpaceModal: React.FC<HasteHomeSpaceModalProps> = ({
  selectedPopImage,
  setSelectedPopImage,
}) => {
  ...
  React.useEffect(() => {
    if (selectedPopImage && selectedPopImage.autoPlayVideo) {
    ...
    <AnimatePresence>
      {selectedPopImage && (
        <motion.div
          ...
          onClick={() => setSelectedPopImage(null)}
        >
          <motion.div
          ...
          >
            ...
            <div className="md:w-3/5 bg-stone-950 flex items-center justify-center relative min-h-[180px] sm:min-h-[240px] md:min-h-[480px]">
              {(() => {
            ...
            <div className="md:w-2/5 p-4 md:p-8 flex flex-col justify-between bg-stone-50 overflow-y-auto">
              <div className="space-y-3.5 md:space-y-5 text-left pt-1 md:pt-2">
                <div>
                  ...
                  <p className="text-stone-500 font-sans text-xs italic mt-0.5">
                    {selectedPopImage.styleSubtitle}
                  </p>
                </div>

                <div className="border-t border-stone-200 pt-3 md:pt-4">
                  ...
                  <p className="text-stone-700 font-sans text-xs font-light leading-relaxed whitespace-pre-line">
