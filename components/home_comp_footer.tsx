...
export const HasteFooter: React.FC<HasteFooterProps> = ({
  ...
  return (
    <>
      ...
      <footer className="bg-[var(--haste-footer-bg)] text-stone-300 mt-16 border-t border-[#C5A059]/20 py-16 px-6 font-sans">
        <div className="container mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
          ...
          <div className="md:col-span-6 flex flex-col gap-4 md:pt-[52px]">
            <div className="haste-body-text-2-3 flex flex-col gap-1 tracking-wide leading-relaxed">
              <span>상호: 헤이스트 (HASTE Co., Ltd.) | 대표이사: 김성규 | 사업자번호: 658-61-00630</span>
              <span>소재지: 경기도 김포시 김포한강11로 | 상담문의 대표번호: 1588-xxxx</span>
              <a 
      ...
      <div className={`fixed right-2 bottom-4 sm:right-6 sm:bottom-10 z-50 flex flex-col gap-1 sm:gap-3.5 items-end select-none ${mockMobileFrame ? 'hidden' : ''}`}>
        ...
        >
          ...
          <span className="font-sans text-[6.5px] sm:text-sm font-black text-stone-900 tracking-tight leading-none mt-0.5">1588-</span>
          <span className="font-sans text-[6.5px] sm:text-sm font-black text-stone-900 tracking-tight leading-none sm:mt-0.5">xxxx</span>
        </button>
