...
export const HasteLicenseCard: React.FC<HasteLicenseCardProps> = ({
  ...
  return (
    <div className={`bg-white border border-stone-200 rounded-[20px] shadow-md flex flex-col text-left font-sans relative overflow-hidden select-none w-full h-full justify-start ${isComp ? 'p-3.5 gap-2.5' : 'p-5 md:p-6 gap-4'}`}
      style={{
