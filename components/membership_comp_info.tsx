...
export const HasteMyInfoTab: React.FC<HasteMyInfoTabProps> = ({
  ...
  return (
    <div className="bg-[#FAF6EE] border border-dashed border-[#C5A059]/50 rounded-[20px] shadow-md flex flex-col relative overflow-hidden font-sans text-left w-full h-full justify-between p-3.5 md:p-6 gap-3.5 md:gap-5 md:min-h-[400px]"
      style={{
      ...
      <div className="flex flex-col z-10 bg-[#C5A059]/10 border border-[#C5A059]/30 rounded-2xl gap-2.5 md:gap-3.5 p-3 md:p-4">
        ...
        <div className="flex flex-col gap-1.5 sm:flex-row sm:items-center justify-between text-xs pb-1">
          ...
          <div className="mt-1 sm:mt-0">
            <a
              href={user.agreement_document_url || license?.agreementDocumentUrl || user.agreementDocumentUrl || '#'}
              target="_blank"
              rel="noreferrer"
              className="haste-dark-mini-btn !text-[9.5px] sm:!text-[10.5px] !px-1.5 !py-0.5 sm:!px-2 sm:!py-1 flex items-center gap-1.5"
              download={`membership_agreement_${uStoreCode}.png`}
            >
              <Download size={10} />
              <span>다운로드</span>
            </a>
