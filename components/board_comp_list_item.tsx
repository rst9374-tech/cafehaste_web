            ...
            {(() => {
              return (
                <div className="flex items-center gap-1.5 flex-1 min-w-0">
                  ...
                  <strong className={`haste-body-text-1 hover:text-[#C5A059] transition-colors truncate block !text-[13px] md:!text-[15px] flex-1 min-w-0 ${
                    isNotice ? '!font-black !text-stone-950' : '!font-bold !text-stone-850'
                  }`}>
