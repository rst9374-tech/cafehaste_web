...
const RAW_MENU_ITEMS: MenuItemRaw[] = [
  ...
  { id: 'AME_ICED_SHOTCHU', category: 'AMERICANO', nameKr: 'ICED 아샷추', nameEng: 'ICED Peach Black Tea with Espresso Shot' },
  { id: 'AME_ICED_DOUBLE_SHOTCHU', category: 'AMERICANO', nameKr: 'ICED 더블아샷추', nameEng: 'ICED Double Shotchu' },
  ...
  { id: 'LAT_HOT_CARAMEL', category: 'COFFEE_LATTE', nameKr: 'HOT 카라멜마끼아또', nameEng: 'HOT Caramel Macchiato' },
  { id: 'LAT_ICED_CARAMEL', category: 'COFFEE_LATTE', nameKr: 'ICED 카라멜마끼아또', nameEng: 'ICED Caramel Macchiato' },
  ...
  { id: 'LAT_HOT_GSHOT', category: 'COFFEE_LATTE', nameKr: 'HOT 그샷추', nameEng: 'HOT Green Tea Latte with Espresso Shot' },
  { id: 'LAT_ICED_GSHOT', category: 'COFFEE_LATTE', nameKr: 'ICED 그샷추', nameEng: 'ICED Green Tea Latte with Espresso Shot' },
  { id: 'LAT_HOT_PPASHOT', category: 'COFFEE_LATTE', nameKr: 'HOT 빠샷추', nameEng: 'HOT Banana Latte with Espresso Shot' },
  { id: 'LAT_ICED_PPASHOT', category: 'COFFEE_LATTE', nameKr: 'ICED 빠샷추', nameEng: 'ICED Banana Latte with Espresso Shot' },
  { id: 'LAT_HOT_MALCHA_SHOT', category: 'COFFEE_LATTE', nameKr: 'HOT 말차샷라떼', nameEng: 'HOT Malcha Shot Latte' },
  { id: 'LAT_ICED_MALCHA_SHOT', category: 'COFFEE_LATTE', nameKr: 'ICED 말차샷라떼', nameEng: 'ICED Malcha Shot Latte' },
  ...
  { id: 'LAT_HOT_CHOUX_ESPRESSO', category: 'COFFEE_LATTE', nameKr: 'HOT 슈크림프레소', nameEng: 'HOT Choux Cream Espresso Latte' },
  { id: 'LAT_ICED_CHOUX_ESPRESSO', category: 'COFFEE_LATTE', nameKr: 'ICED 슈크림프레소', nameEng: 'ICED Choux Cream Espresso Latte' },
  ...
  { id: 'MILK_HOT_MALCHA_CHOCO', category: 'MILK_LATTE', nameKr: 'HOT 말차초코라떼', nameEng: 'HOT Malcha Choco Latte' },
  { id: 'MILK_ICED_MALCHA_CHOCO', category: 'MILK_LATTE', nameKr: 'ICED 말차초코라떼', nameEng: 'ICED Malcha Choco Latte' },
  ...
  { id: 'MILK_HOT_CHOCO_HAZEL', category: 'MILK_LATTE', nameKr: 'HOT 초콜릿헤이즐넛', nameEng: 'HOT Chocolate Hazelnut' },
  { id: 'MILK_ICED_CHOCO_HAZEL', category: 'MILK_LATTE', nameKr: 'ICED 초콜릿헤이즐넛', nameEng: 'ICED Chocolate Hazelnut' },
  { id: 'MILK_ICED_STRAWBERRY', category: 'MILK_LATTE', nameKr: 'ICED 딸기라떼', nameEng: 'ICED Strawberry Latte' },
  { id: 'MILK_HOT_STRAWBERRY_CHOUX', category: 'MILK_LATTE', nameKr: 'HOT 딸기슈크림', nameEng: 'HOT Strawberry Choux Cream' },
  { id: 'MILK_ICED_STRAWBERRY_CHOUX', category: 'MILK_LATTE', nameKr: 'ICED 딸기슈크림', nameEng: 'ICED Strawberry Choux Cream' },
  ...
  { id: 'MILK_HOT_MALCHA', category: 'MILK_LATTE', nameKr: 'HOT 말차라떼', nameEng: 'HOT Malcha Latte' },
  { id: 'MILK_ICED_MALCHA', category: 'MILK_LATTE', nameKr: 'ICED 말차라떼', nameEng: 'ICED Malcha Latte' },
  { id: 'MILK_HOT_GOGUMA_GREEN_TEA', category: 'MILK_LATTE', nameKr: 'HOT 군고구마그린티라떼', nameEng: 'HOT Goguma Green Tea Latte' },
  { id: 'MILK_ICED_GOGUMA_GREEN_TEA', category: 'MILK_LATTE', nameKr: 'ICED 군고구마그린티라떼', nameEng: 'ICED Goguma Green Tea Latte' },
  { id: 'MILK_HOT_GOGUMA_MALCHA', category: 'MILK_LATTE', nameKr: 'HOT 군고구마말차라떼', nameEng: 'HOT Goguma Malcha Latte' },
  { id: 'MILK_ICED_GOGUMA_MALCHA', category: 'MILK_LATTE', nameKr: 'ICED 군고구마말차라떼', nameEng: 'ICED Goguma Malcha Latte' },
  ...
  { id: 'MILK_ICED_GONGJU_WATGUMA', category: 'MILK_LATTE', nameKr: 'ICED 공주밤이왔구마', nameEng: 'ICED Gongju Watguma' },
  ...
  { id: 'MILK_HOT_GOGUMA_CARAMEL', category: 'MILK_LATTE', nameKr: 'HOT 군고구마카라멜라떼', nameEng: 'HOT Goguma Caramel Latte' },
  { id: 'MILK_ICED_GOGUMA_CARAMEL', category: 'MILK_LATTE', nameKr: 'ICED 군고구마카라멜라떼', nameEng: 'ICED Goguma Caramel Latte' },
  { id: 'MILK_HOT_CHESTNUT_GREY', category: 'MILK_LATTE', nameKr: 'HOT 공주밤그레이', nameEng: 'HOT Gongju Chestnut Grey' },
  { id: 'MILK_ICED_CHESTNUT_GREY', category: 'MILK_LATTE', nameKr: 'ICED 공주밤그레이', nameEng: 'ICED Gongju Chestnut Grey' },
  ...
  { id: 'MILK_ICED_PLUM_VANILLA', category: 'MILK_LATTE', nameKr: 'ICED 플럼바닐라라떼', nameEng: 'ICED Plum Vanilla Latte' },
  { id: 'MILK_HOT_GREEN_TEA_HAZEL', category: 'MILK_LATTE', nameKr: 'HOT 그린티헤이즐넛', nameEng: 'HOT Green Tea Hazelnut' },
  { id: 'MILK_ICED_GREEN_TEA_HAZEL', category: 'MILK_LATTE', nameKr: 'ICED 그린티헤이즐넛', nameEng: 'ICED Green Tea Hazelnut' },
  { id: 'MILK_HOT_BANANA_HAZEL', category: 'MILK_LATTE', nameKr: 'HOT 바나나헤이즐넛', nameEng: 'HOT Banana Hazelnut' },
  { id: 'MILK_ICED_BANANA_HAZEL', category: 'MILK_LATTE', nameKr: 'ICED 바나나헤이즐넛', nameEng: 'ICED Banana Hazelnut' },
  { id: 'MILK_HOT_CARAMEL_HAZEL', category: 'MILK_LATTE', nameKr: 'HOT 카라멜헤이즐넛', nameEng: 'HOT Caramel Hazelnut' },
  { id: 'MILK_ICED_CARAMEL_HAZEL', category: 'MILK_LATTE', nameKr: 'ICED 카라멜헤이즐넛', nameEng: 'ICED Caramel Hazelnut' },
  { id: 'MILK_HOT_CHOUX_CREAM', category: 'MILK_LATTE', nameKr: 'HOT 슈크림라떼', nameEng: 'HOT Choux Cream Latte' },
  { id: 'MILK_ICED_CHOUX_CREAM', category: 'MILK_LATTE', nameKr: 'ICED 슈크림라떼', nameEng: 'ICED Choux Cream Latte' },
  { id: 'MILK_HOT_EARL_GREY_CHOUX', category: 'MILK_LATTE', nameKr: 'HOT 얼그레이슈크림', nameEng: 'HOT Earl Grey Choux Cream' },
  { id: 'MILK_ICED_EARL_GREY_CHOUX', category: 'MILK_LATTE', nameKr: 'ICED 얼그레이슈크림', nameEng: 'ICED Earl Grey Choux Cream' },
  ...
  // 5. 티베이스
  { id: 'TEA_HOT_OMIZA', category: 'TEA_BASE', nameKr: 'HOT 오미자차', nameEng: 'HOT Omiza Tea' },
  { id: 'TEA_ICED_OMIZA', category: 'TEA_BASE', nameKr: 'ICED 오미자차', nameEng: 'ICED Omiza Tea' },
  ...
  { id: 'TEA_HOT_PLUM', category: 'TEA_BASE', nameKr: 'HOT 자두차', nameEng: 'HOT Plum Tea' },
  { id: 'TEA_ICED_PLUM', category: 'TEA_BASE', nameKr: 'ICED 자두차', nameEng: 'ICED Plum Tea' },
  ...
  { id: 'TEA_HOT_HONEY_LEMON_BLACK', category: 'TEA_BASE', nameKr: 'HOT 허니레몬블랙티', nameEng: 'HOT Honey Lemon Black Tea' },
  { id: 'TEA_ICED_HONEY_LEMON_BLACK', category: 'TEA_BASE', nameKr: 'ICED 허니레몬블랙티', nameEng: 'ICED Honey Lemon Black Tea' },
  ...
  { id: 'ADE_ICED_BANANA_GRAPEFRUIT', category: 'ADE_ETC', nameKr: 'ICED 바나나자몽에이드', nameEng: 'ICED Banana Grapefruit Ade' },
  ...
  { id: 'ADE_ICED_HONEY_GRAPEFRUIT_BLACK', category: 'ADE_ETC', nameKr: 'ICED 허니자몽블랙에이드', nameEng: 'ICED Honey Grapefruit Black Ade' },
  ...
  { id: 'ADE_ICED_BANANA_LEMON', category: 'ADE_ETC', nameKr: 'ICED 바나나레몬에이드', nameEng: 'ICED Banana Lemon Ade' },
  { id: 'ADE_ICED_HONEY_LEMON_BLACK', category: 'ADE_ETC', nameKr: 'ICED 허니레몬블랙에이드', nameEng: 'ICED Honey Lemon Black Ade' },
  ...
  { id: 'ADE_ICED_OMIZA', category: 'ADE_ETC', nameKr: 'ICED 오미자에이드', nameEng: 'ICED Omiza Ade' },
  ...
  { id: 'ADE_ICED_GREEN_BALL', category: 'ADE_ETC', nameKr: 'ICED 그린볼', nameEng: 'ICED Green Ball' },
  { id: 'ADE_ICED_BLACK_BALL', category: 'ADE_ETC', nameKr: 'ICED 블랙볼', nameEng: 'ICED Black Ball' },
  { id: 'ADE_ICED_COFFEE_BANANA_BALL', category: 'ADE_ETC', nameKr: 'ICED 커반볼', nameEng: 'ICED Coffee Banana Ball' },
  { id: 'ADE_ICED_PLUM_BALL', category: 'ADE_ETC', nameKr: 'ICED 플럼볼', nameEng: 'ICED Plum Ball' },
  { id: 'ADE_ICED_PEACH_LEMON_BALL', category: 'ADE_ETC', nameKr: 'ICED 피치레몬볼', nameEng: 'ICED Peach Lemon Ball' },
  { id: 'ETC_ICE_WATER', category: 'ADE_ETC', nameKr: 'ICED 냉수', nameEng: 'ICED Water' },
  { id: 'ETC_HOT_WATER', category: 'ADE_ETC', nameKr: 'HOT 온수', nameEng: 'HOT Water' },
...
export const getPresetImageAndFlavor = (id: string, nameKr: string) => {
  ...
  if (nameKr.includes('아메리카노') || nameKr.includes('도피오') || nameKr.includes('아샷추')) {
    acidity = 2;
    sweetness = nameKr.includes('설탕') || nameKr.includes('헤이즐넛') || nameKr.includes('아샷추') ? 3 : 1;
    body = 3;
    bitterness = nameKr.includes('샷추가') ? 4 : 3;
  } else if (nameKr.includes('라떼') || nameKr.includes('마끼아또') || nameKr.includes('모카') || nameKr.includes('프레소') || nameKr.includes('빠샷추') || nameKr.includes('그샷추') || nameKr.includes('왔구마') || nameKr.includes('공주밤초코') || nameKr.includes('군고구마초코')) {
...
export const getDescription = (nameKr: string) => {
  ...
  if (nameKr.includes('카라멜마끼아또') || nameKr.includes('바닐라카라멜') || nameKr.includes('오렌지카라멜')) {
